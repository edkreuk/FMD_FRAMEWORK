...
def assign_workspace_roles(workspace, workspace_name):
    ...
    for role in workspace['roles']:
        try:
            ...
            print(f"✅ Role '{role['role']}' Assigned to '{role['principal']}' in workspace '{workspace_name}'")
        except Exception as e:
...
def assign_workspace_identity_role(workspace_name):
    ...
    try:
        ...
        print(f"✅ Managed identity assigned to Contributor in '{workspace_name}'")
    except Exception as e:
        print(f"❌ Failed to assign managed identity: {e}")
...
def assign_item_to_folder(workspace_name, item_id, folder_name):
    ...
    try:
        ...
        print(f"✅ Folder {folder} assigned to item in workspace '{workspace_name}'")
    except Exception as e:
